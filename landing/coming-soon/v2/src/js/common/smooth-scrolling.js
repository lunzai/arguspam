...
const smoothScrolling = () => {
  // Lenis disabled - using native smooth scroll for anchor links only
  // This prevents the weird manual scrolling behavior
...
const smoothScrollAnchors = () => {
  ...
  document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    anchor.addEventListener('click', function (e) {
      ...
      // Skip if href is just "#" (for home/top)
      if (href === '#') {
        e.preventDefault();
        window.scrollTo({
          top: 0,
