...
class RequestPolicyTest extends TestCase
{
    ...
    public function test_view_returns_false_when_user_is_not_requester_and_lacks_viewAny_permission(): void
    {
    ...
    public function test_update_returns_false_when_user_is_not_requester_and_lacks_updateAny_permission(): void
    {
    ...
    public function test_approveAny_returns_true_when_user_has_permission(): void
    {
    ...
    public function test_approveAny_returns_false_when_user_lacks_permission(): void
    {
        $this->assertFalse($this->policy->approveAny($this->user));
    }

    public function test_approve_returns_true_when_user_has_approveAny_permission(): void
    {
        $this->giveUserPermission($this->user, 'request:approveany');
    ...
    public function test_rejectAny_returns_true_when_user_has_permission(): void
    {
    ...
    public function test_rejectAny_returns_false_when_user_lacks_permission(): void
    {
        $this->assertFalse($this->policy->rejectAny($this->user));
    }

    public function test_reject_returns_true_when_user_has_rejectAny_permission(): void
    {
        $this->giveUserPermission($this->user, 'request:rejectany');
