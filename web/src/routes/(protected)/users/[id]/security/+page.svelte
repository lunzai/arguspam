<script lang="ts">
	...
	const canUserResetPasswordAny = $derived(data.canUserResetPasswordAny);
	const canUserEnrollTwoFactorAuthenticationAny = $derived(
		data.canUserEnrollTwoFactorAuthenticationAny
	);
...
<div class="space-y-6">
	...
	{/if}
	{#if canUserEnrollTwoFactorAuthenticationAny}
		<Card.Root class="relative w-full">
