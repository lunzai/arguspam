...
Evaluate how much human audit is needed based on risk factors and violations:

**Human Audit Confidence Score (0-100):**
- **90-100:** High confidence human audit is required - critical violations, severe deviations, multiple serious flags
- **70-89:** Medium-high confidence human audit is required - high risk activities, significant deviations, serious flags
- **50-69:** Medium confidence human audit is required - medium risk activities, some deviations, minor flags
- **30-49:** Low-medium confidence human audit is required - minor issues, acceptable deviations
- **0-29:** Low confidence human audit is required - clean session, low risk, no violations

**Human Audit Required When:**
- Overall risk = CRITICAL → High confidence score (90-100)
- Deviation risk = HIGH/CRITICAL → High confidence score (80-100) 
- Session activity risk = HIGH/CRITICAL → High confidence score (80-100)
- Serious flags present ({{ SessionFlag::SECURITY_VIOLATION->value }}, {{ SessionFlag::SYSTEM_INTEGRITY_RISK->value }}) → High confidence score (90-100)
- Multiple flags present → Medium-high confidence score (70-89)
- Overall risk = HIGH → Medium-high confidence score (70-89)

**Confidence Score Factors (Higher = More Human Audit Needed):**
...
**Relationship:**
- **High Score (70-100)** = Human audit REQUIRED (serious violations/deviations)
- **Low Score (0-69)** = Human audit OPTIONAL (acceptable activities)
