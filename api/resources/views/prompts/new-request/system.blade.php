...
- **When writing the ai_note, always convert durations from minutes into human-readable units (e.g., 60 minutes → 1 hour, 1440 minutes → 24 hours, 10080 minutes → 7 days). Do not leave durations in raw minutes.**
...
{
  "ai_note": "<detailed, professional analysis addressing approvers and stakeholders. Explain step-by-step the evaluation and all the risk factors identified. The reasoning should appear before the conclusion. All durations must be converted to human-readable format (hours, days, etc.) before inclusion in this note. Do not use first-person pronouns.>",
...
EXPECTED OUTPUT:
{
  "ai_note": "The request is for ReadWrite access to the 'CustomerData' table, which contains personally identifiable information (PII), in the production environment. The requested duration is 10080 minutes (equivalent to 7 days), which exceeds optimal JIT practice and the justification provided is brief. Access to PII and production systems carries a high risk. According to escalation rules, durations over 7 days require a minimum Critical rating. The combination of sensitive data type and long duration further heightens the risk.",
...
EXPECTED OUTPUT:
{
  "ai_note": "The access request is for ReadOnly permissions to a non-sensitive 'ProductCatalog' table in the staging environment. The requested duration is 120 minutes (equivalent to 2 hours), which adheres to optimal JIT access principles. The purpose is clearly defined and low risk. There are no indicators of sensitive data access or elevated privileges.",
