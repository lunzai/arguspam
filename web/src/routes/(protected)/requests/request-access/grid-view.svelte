...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-6">
    {#each table.getRowModel().rows as row (row.id)}
        <Card.Root class="@container/card rounded-xl shadow-xs border-0 hover:shadow-[0_20px_50px_-12px_rgba(23,28,35,0.08)]">
            <Card.Content class="px-6 grow">
                <div class="flex flex-col gap-6">
                    <div class="flex justify-between items-center gap-2">
                        ...
                        <DbmsBadge dbms={row.original.dbms} class="text-[10px] font-extrabold uppercase tracking-widest py-1 px-3 rounded-full" />
                    </div>
                    <div>
            ...
            <Card.Footer>
                <div class="flex items-center justify-between w-full gap-2">
                    ...
                    <Button 
                        ...
                        href={`/requests/request-access/${row.original.id}`}
                    >
