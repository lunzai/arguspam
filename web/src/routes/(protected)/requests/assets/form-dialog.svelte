<script lang="ts">
	...
	const form = superForm(data, {
		validators: zodClient(RequesterSchema),
		delayMs: 100,
...
<Dialog.Root bind:open={isOpen}>
	<Dialog.Content class="sm:max-w-2xl max-h-[90vh] overflow-y-auto" interactOutsideBehavior="ignore">
		...
		{/if}
		<form class="space-y-6 min-w-0" method="POST" use:enhance>
			...
			<Dialog.Header>
                ...
                <div class="flex justify-between items-center gap-x-3 py-4 px-6 bg-gray-50 text-sm">
                    <div class="flex flex-col gap-1.5 min-w-0">
                        ...
                        {/if}
                        <div class="flex min-h-6 items-center gap-1.5 truncate text-gray-500 text-sm/5">
            ...
            <div class="space-y-6">
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <Form.Field {form} name="end_datetime">
                        ...
                        <Form.FieldErrors />
                        {#if $errors.duration}
                            <p class="text-destructive font-medium text-sm">{$errors.duration}</p>
                        {/if}
                    </Form.Field>
                </div>
                        ...
                        <Form.Label>
                            ...
                            <Tooltip.Root>
                                ...
                                <Tooltip.Content>
                                    <div class="">
                                        <ul>
                                            <li><span class="font-bold">ReadOnly:</span> View data only (SELECT queries)</li>
                                            <li><span class="font-bold">ReadWrite:</span> View and modify data (SELECT, INSERT, UPDATE, DELETE)</li>
                                            <li><span class="font-bold">DDL:</span> Manage database structure (CREATE, ALTER, DROP tables/indexes)</li>
                                            <li><span class="font-bold">DML:</span> Manipulate data operations (INSERT, UPDATE, DELETE, SELECT)</li>
                                            <li><span class="font-bold">All:</span> Full database access (all operations and administrative functions)</li>
                                        </ul>
                                    </div>
                                </Tooltip.Content>
                            </Tooltip.Root>
