...
export interface ApiUserAccessRestrictionCollection extends ApiCollectionResponse<UserAccessRestriction> {}
export interface ApiUserAccessRestrictionResource extends ApiResourceResponse<UserAccessRestriction> {}
