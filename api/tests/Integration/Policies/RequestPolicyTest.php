...
class RequestPolicyTest extends TestCase
{
    ...
    public function test_approve_returns_true_when_user_can_approve_asset_and_has_permission(): void
    {
    ...
    public function test_reject_returns_true_when_user_can_approve_asset_and_has_permission(): void
    {
    ...
    public function test_cancel_any_returns_true_when_user_has_permission(): void
    {
        $this->giveUserPermission($this->user, 'request:cancelany');

        $this->assertTrue($this->policy->cancelAny($this->user));
    }

    public function test_cancel_any_returns_false_when_user_lacks_permission(): void
    {
        $this->assertFalse($this->policy->cancelAny($this->user));
    }

    public function test_cancel_returns_true_when_user_has_cancel_any_permission(): void
    {
        $this->giveUserPermission($this->user, 'request:cancelany');

        $this->assertTrue($this->policy->cancel($this->user, $this->request));
    }

    public function test_cancel_returns_true_when_user_is_requester_with_cancel_permission(): void
    {
        $this->giveUserPermission($this->requester, 'request:cancel');

        $this->assertTrue($this->policy->cancel($this->requester, $this->request));
    }
    ...
    public function test_cancel_returns_false_when_user_is_not_requester(): void
    {
        ...
        $this->assertFalse($this->policy->cancel($this->user, $this->request));
    }

    public function test_cancel_returns_false_when_user_lacks_permission(): void
    {
        $this->assertFalse($this->policy->cancel($this->requester, $this->request));
    }
