...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Test database connections for integration tests
        'testing_mysql' => [
            'driver' => 'mysql',
            'host' => env('TEST_MYSQL_HOST', '127.0.0.1'),
            'port' => env('TEST_MYSQL_PORT', '3306'),
            'database' => env('TEST_MYSQL_DATABASE', 'arguspam_test'),
        ...
        'testing_pgsql' => [
            ...
            'database' => env('TEST_PGSQL_DATABASE', 'arguspam_test'),
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'argus'), '_').'_db_'),
