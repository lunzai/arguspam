...
<Sidebar.Provider>
	...
	<Sidebar.Inset class="min-w-0 overflow-hidden relative">
		<header class="top-0 z-30 flex justify-start items-center w-full px-8 h-16 bg-white/80 backdrop-blur-md border-b border-slate-200/50 shadow-sm">
