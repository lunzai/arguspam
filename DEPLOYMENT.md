...
2. **Launch an EC2 instance:**
   ...
   - **Instance Type:**
     - **Small:** t4g.small (2 vCPU, 2GB RAM) - ~$15/month
     - **Medium:** t4g.medium (2 vCPU, 4GB RAM) - ~$30/month ⭐ Recommended
     - **Large:** t4g.large (2 vCPU, 8GB RAM) - ~$60/month
     - **Extra Large:** t4g.xlarge (4 vCPU, 16GB RAM) - ~$120/month
...
1. Navigate to your web interface (use IP address initially)
2. **Create Administrator Account:**
   - Click "Register" or "Sign Up"
   - Enter your email and create a strong password
   - Verify your email if required
3. **Log in** with your new credentials
4. **Configure your organization** in the admin panel
5. Start using ArgusPAM!
